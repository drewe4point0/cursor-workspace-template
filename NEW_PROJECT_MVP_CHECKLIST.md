...
- [ ] Ask Claude to clone this repo under a specific project name (eg. 'podcast-transcriber')
    Prompt: Please clone this repo and use it to create a new project (and a new repo) named: ____-____-____  Please also rename the project name and description in the new project's @CLAUDE.md 
